<template>
  <Layout>
    <article class="max-w-3xl mx-auto rounded-lg shadow-2xl mt-10 mb-10">
          ...
          <div class="flex items-start justify-start gap-10 mt-10">
              <div class="w-2/6 mt-6 bg-gray-800 text-gray-200 rounded-md p-4">
